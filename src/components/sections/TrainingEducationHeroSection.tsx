        ...
        <div className="max-w-4xl">
          <Reveal direction="down">
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-plra-gold text-xs font-black tracking-[0.4em] uppercase">Master the Craft</span>
            </div>
          </Reveal>
          <Reveal delay={0.3}>
            <h1 className="text-white text-5xl md:text-7xl font-black tracking-tighter leading-none mb-6">
              TRAINING & <span className="text-transparent bg-clip-text bg-gradient-to-r from-plra-accent-purple to-plra-accent-pink">EDUCATION</span>
            </h1>
          </Reveal>
          <Reveal delay={0.5}>
            <p className="text-gray-300 text-lg md:text-xl max-w-2xl leading-relaxed font-medium">
              Structured shooting education designed to take you from the fundamentals of safety to the pinnacle of long-range precision.
            </p>
          </Reveal>
          <Reveal delay={0.7}>
            <div className="flex items-center text-xs font-black uppercase tracking-widest text-gray-400 mt-8">
              ...
              <span className="text-white">Training & Education</span>
            </div>
          </Reveal>
        </div>
      </div>
