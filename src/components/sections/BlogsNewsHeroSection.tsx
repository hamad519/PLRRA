        ...
        <div className="max-w-4xl">
          <Reveal direction="down">
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-plra-gold text-xs font-black tracking-[0.4em] uppercase">Latest Updates</span>
            </div>
          </Reveal>
          <Reveal delay={0.3}>
            <h1 className="text-white text-5xl md:text-7xl font-black tracking-tighter leading-none mb-6">
              BLOGS & <span className="text-transparent bg-clip-text bg-gradient-to-r from-plra-accent-purple to-plra-accent-pink">NEWS</span>
            </h1>
          </Reveal>
          <Reveal delay={0.5}>
            <p className="text-gray-300 text-lg md:text-xl max-w-2xl leading-relaxed font-medium">
              Stay informed with the latest announcements, event highlights, and expert insights from the Pakistan Long Range Rifle Association.
            </p>
          </Reveal>
          <Reveal delay={0.7}>
            <div className="flex items-center text-xs font-black uppercase tracking-widest text-gray-400 mt-8">
              ...
              <span className="text-white">Blogs & News</span>
            </div>
          </Reveal>
        </div>
      </div>
