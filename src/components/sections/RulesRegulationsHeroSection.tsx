        ...
        <div className="max-w-4xl">
          <Reveal direction="down">
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-plra-gold text-xs font-black tracking-[0.4em] uppercase">Standards of Excellence</span>
            </div>
          </Reveal>
          <Reveal delay={0.3}>
            <h1 className="text-white text-5xl md:text-7xl font-black tracking-tighter leading-none mb-6">
              RULES & <span className="text-transparent bg-clip-text bg-gradient-to-r from-plra-gold to-orange-500">REGULATIONS</span>
            </h1>
          </Reveal>
          <Reveal delay={0.5}>
            <p className="text-gray-300 text-lg md:text-xl max-w-2xl leading-relaxed font-medium">
              Upholding the highest standards of safety, discipline, and fair play. Our comprehensive guidelines ensure a professional environment for all marksmen.
            </p>
          </Reveal>
          <Reveal delay={0.7}>
