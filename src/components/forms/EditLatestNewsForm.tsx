...
export const EditLatestNewsForm = ({ id }: Props) => {
  ...
  if (isFetching) {
    return (
      <Card className="max-w-2xl mx-auto bg-white border-admin-border shadow-xl rounded-[2rem]">
        <CardContent className="p-8 flex justify-center items-center h-48">
          <p className="text-admin-text-secondary font-medium">Loading...</p>
        </CardContent>
      </Card>
    );
  }
    ...
    <Card className="max-w-2xl mx-auto bg-white border-admin-border shadow-xl rounded-[2rem]">
      <CardHeader className="p-8 bg-admin-bg/50 border-b border-admin-border">
        <CardTitle className="text-2xl font-black flex items-center gap-3">
          <Newspaper className="text-admin-accent" /> Edit News Item
        </CardTitle>
      </CardHeader>
